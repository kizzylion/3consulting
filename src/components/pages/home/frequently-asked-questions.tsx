  ...
  return (
    <section id='faq' className='py-16 md:py-24'>
      <div className='max-w-7xl mx-auto w-full h-fit px-5 md:px-8 '>
        <div className='flex flex-col gap-y-3 text-center mb-12 md:mb-16'>
        ...
        <div className='flex justify-center md:max-w-3xl mx-auto divide-y divide-gray-200'>
          <Accordion className='w-full'>
            ...
            <Accordion.Item index={1} className='border-none py-4'>
              ...
              >
                <p className='text-md font-medium'>
                  Why should I outsource my Data Protection Officer (DPO)
                  services to 3Consulting?
                </p>
              </Accordion.Trigger>
              <Accordion.Content>
                <span>
                  ...
                  compliance monitoring, risk assessments, policy development,
                  and responding to data subject requests. We also provide
                  ongoing support to ensure you stay compliant with
            ...
            <Accordion.Item index={2} className='border-none py-4'>
              ...
              <Accordion.Content>
                <span>
                  ...
                  enhance your project execution. We use the Agile Methodology
                  to ensure flexibility and adaptability while providing
                  resource augmentation to meet your project needs. Our team
                  ensures that your projects are delivered on time, within
                  scope, and with high efficiency.
                </span>
              </Accordion.Content>
            </Accordion.Item>
            <div className='border border-gray-200' />
            <Accordion.Item index={3} className='border-none py-4'>
              ...
              <Accordion.Content>
                <span>
                  ...
                  It's perfect for those looking to advance their careers in
                  data privacy or strengthen their organization's compliance
                  efforts.
                </span>
              </Accordion.Content>
            </Accordion.Item>
