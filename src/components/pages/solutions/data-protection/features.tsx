    ...
    <section id="feature" className=" bg-white">
      <div className="px-5 mx-auto max-w-7xl md:px-6 text-pretty">
        ...
        <div id="features-list" className="flex flex-col gap-12 lg:gap-16">
          <div className="grid grid-cols-1 gap-10 w-full h-fit feature items-center lg:grid-cols-2 lg:gap-24 overflow-hidden">
            <div className="order-first lg:order-last image-section  w-full h-full grid grid-cols-1 place-content-center overflow-hidden">
              <img
                src={featImg1}
                alt=""
                draggable="false"
            ...
            <div className="order-last content-section w-full h-fit lg:order-first">
          ...
          <div className="grid grid-cols-1 gap-10 w-full h-fit feature items-center lg:grid-cols-2 lg:gap-24 overflow-hidden">
            <div className="order-first image-section size-full grid grid-cols-1 place-content-center overflow-hidden">
              <img
                src={featImg2}
                alt=""
                draggable="false"
            ...
            <div className="order-last content-section w-full h-fit ">
              <div className="content-heading">
                <h3 className="mb-5 text-2xl font-medium leading-5 text-gray-950">
                  Policy Development
                </h3>
          ...
          <div className="grid grid-cols-1 gap-10 w-full h-fit feature items-center lg:grid-cols-2 lg:gap-24 overflow-hidden">
            <div className="order-first lg:order-last image-section aspect-video size-full grid grid-cols-1 place-content-center overflow-hidden">
              <img
                src={featImg3}
                alt=""
                draggable="false"
          ...
          <div className="grid grid-cols-1 gap-10 w-full h-fit feature items-center lg:grid-cols-2 lg:gap-24 overflow-hidden">
            <div className="order-first  image-section aspect-video size-full grid grid-cols-1 place-content-center overflow-hidden">
              <img
                src={featImg4}
                alt=""
                draggable="false"
