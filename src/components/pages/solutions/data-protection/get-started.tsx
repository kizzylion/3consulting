      ...
      <div className="max-w-7xl lg:mx-auto md:px-8">
        <div className="p-8 bg-gray-900 md:rounded-2xl md:p-12">
          <div className="flex flex-col gap-8 justify-between items-center w-full md:flex-row">
            ...
            <div className="flex flex-col-reverse shrink-0  gap-4 w-full md:w-fit lg:flex-row">
              <Button className="w-full text-gray-900 bg-white lg:w-fit">
                Learn More
              </Button>
              <Button className="w-full lg:w-fit">Enrol Now</Button>
            </div>
          </div>
        </div>
      </div>
